...
class Review(models.Model):
    ...
    reviewer = models.ForeignKey(
        Employee, on_delete=models.CASCADE, related_name='reviewer2id')
    # The employee that requested to have a review written about them
    reviewee = models.ForeignKey(
        Employee, on_delete=models.CASCADE, related_name='reviewee2id')
...
class Request(models.Model):
    ...
    requestee = models.ForeignKey(
        Employee, on_delete=models.CASCADE, related_name='requestee2id')
    # The employee that requested to have a review written about them
    requestor = models.ForeignKey(
        Employee, on_delete=models.CASCADE, related_name='requestor2id')
